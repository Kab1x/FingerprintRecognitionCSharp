...
from utils.crossing_number import returnResults
from utils.crossing_number import resetNbrs
...
def fingerprint_pipline(input_img):
    ...
    print("\nEndings: " + str(returnResults(0)) + " Bifurcations: " + str(returnResults(1)))
...
if __name__ == '__main__':
    ...
    for i, img in enumerate(tqdm(images)):
        ...
        endingNbr = returnResults(0)
        bifurcationsNbr = returnResults(1)

        fileRes = open(output_dir+str(i)+'.txt', "w+")
        fileRes.writelines(str(endingNbr) + "\n" + str(bifurcationsNbr))
